...
class TestJsonSerde:
    ...
    def test_save_load_events_json(self) -> None:
        ...
        try:
            ...
            assert isinstance(loaded_events[1], CardSwipeEvent)
            assert loaded_events[1].amount == -2550
            assert loaded_events[1].merchant == "Starbucks"
            assert loaded_events[1].category == "Food & Drink"
